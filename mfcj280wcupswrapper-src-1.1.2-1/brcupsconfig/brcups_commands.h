...
#ifndef _BRDEF1_    /*BRDEF1,Add by developper4,2008.4.17*/
#define _BRDEF1_
#endif   /*_BRDEF1_*/

#ifndef _BRDEF2_LINUX_DRIVER_		/*BRDEF2, Add by  developper2, 2010-08-12*/
#define _BRDEF2_LINUX_DRIVER_
#endif		// end _BRDEF2_LINUX_DRIVER_

#ifndef _BRDEF3_LINUX_DRIVER_	// Added by  developper2, 2011-03-09
#define _BRDEF3_LINUX_DRIVER_
#endif // end _BRDEF3_LINUX_DRIVER_
...
#ifndef _BRDEF2_LINUX_DRIVER_ // Removed by  developper2, 2010-08-12
	// Collate
	{  "Collate=OFF"			,	"-collate OFF"      },
	{  "Collate=ON"				,	"-collate ON"      },
#endif  // end _BRDEF2_LINUX_DRIVER_

#ifdef _BRDEF2_LINUX_DRIVER_ // Modified by  developper2, 2010-08-12
...
#ifdef _BRDEF3_LINUX_DRIVER_       // Added by  developper2, 2011-03-09    
...
#endif // end _BRDEF3_LINUX_DRIVER_
#else    // _BRDEF2_LINUX_DRIVER_
  // Media  
#ifdef _BRDEF1_    /*BRDEF1,Add by developper4,2008.4.17*/
...
// Paper
#ifdef _BRDEF2_LINUX_DRIVER_ // Modified by  developper2, 2010-08-12
#ifndef _BRDEF3_LINUX_DRIVER_ // Removed by  developper2, 2011-03-09
	{  "PageSize=A3"				,	"-pt A3"			},
...
//	{  "media=EnvYou4"				,	"-pt EnvYou4"			},
  ...
  { "PageSize=BrA3_B_S",				"-pt BrA3_B_S" },
  { "PageSize=BrA3_B_A3",				"-pt BrA3_B_A3" }, /*BRDEF1,Add by developper4,2008.4.17*/
  { "PageSize=B4",				"-pt B4" },
  { "PageSize=BrB4_S",				"-pt BrB4_S" },/*BRDEF1,Add by developper4,2008.4.17*/
...
#if 1		// Added by  developper1, 2006.10.17

	// for Command Line
#ifdef _BRDEF1_    /*_BRDEF1_*/    /*Modified by developper4..2008.4.28*/
  { "media=A3",				"-pt BrA3_S" },
  { "media=BrA3_A3",				"-pt BrA3_A3" },
  { "media=BrA3_B_S",				"-pt BrA3_B_S" },
  { "media=BrA3_B_A3",				"-pt BrA3_B_A3" }, /*BRDEF1,Add by developper4,2008.4.17*/
  { "media=B4",				"-pt B4" },
  { "media=BrB4_S",				"-pt BrB4_S" },/*BRDEF1,Add by developper4,2008.4.17*/
...
#ifdef _BRDEF2_LINUX_DRIVER_ // Added by  developper2, 2010-08-12
...
#endif /*_BRDEF1_*/     /*BRDEF1,Add by developper4,2008.4.17*/

	{ NULL   ,   NULL    },
};

#ifdef _BRDEF2_LINUX_DRIVER_ // Added by  developper2, 2010-12-15
...
#ifdef _BRDEF2_LINUX_DRIVER_ // Removed by  developper2, 2010-08-12
	{	"Copies="   	,   "-copy "      },
#endif // end  _BRDEF2_LINUX_DRIVER_
	{	"BRBrightness="	,	"-brit "	},
	{	"BRContrast="		,	"-cont "		},
...
PPDCOMMAND  DefaultPageSize={
    "DefaultPageSize",
  {
#ifndef _BRDEF3_LINUX_DRIVER_ // Removed by  developper2,
       	{  "A3"					,	"-pt A3"			},
	...
	{  "EnvYou4"				,	"-pt EnvYou4"			},
#ifdef _BRDEF3_LINUX_DRIVER_ // Added by  developper2
...
PPDCOMMAND  DefaultPageSize={
  ...
  { "BrA3_A3",				"-pt BrA3_A3" },
  { "BrA3_B_S",				"-pt BrA3_B_S" },
  { "BrA3_B_A3",				"-pt BrA3_B_A3" }, /*BRDEF1,Add by developper4,2008.4.17*/
  { "B4",				"-pt B4" },
  { "BrB4_S",				"-pt BrB4_S" },/*BRDEF1,Add by developper4,2008.4.17*/
...
PPDCOMMAND  DefaultBRMirrorPrint={
	"DefaultBRMirror",
	{
#ifndef _BRDEF1_	/*BRDEF1. Modified by developper3. 20080519*/
		{  "OFF"	,	"-mirro OFF"	},
...
#endif     /*BRDEF1,Add by developper4,2008.4.17*/
...
PPDCOMMAND   *ppdcommand_all_list[] = {
  ...
  &DefaultBRJpeg,
  &DefaultBRReverse,
#ifdef _BRDEF2_LINUX_DRIVER_ // Add by  developper2, 2010-08-12
  &DefaultBRDuplex,
  &DefaultDuplexMode,
  &DefaultBRManualDuplex,
#endif   // end _BRDEF2_LINUX_DRIVER_
