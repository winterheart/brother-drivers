...
#define MFC_J6310W	"mfcj6310w"
#define MFC_J6510DW	"mfcj6510dw"
...
//	sleep(100);
  ...
  while(fgets(ppd_line,sizeof(ppd_line),fp_ppd)){
	...
	//       ppdcommand_all_list[i]->label,ppd_line);
		...
		#if 1		// Added by SteadyBJ, Developer6 , 20080121
			char * tmp;
	  ...
	  //       ppdcommand_all_list[i]->label,ppdcommand_all_list[i]->ppdcommandlist[ii].value ,  ppd_line);
	  		#if 0        // Modified by SteadyBJ, Developer6 , 20080121
  ...
  for ( i = 0; commandlinelist1[i].value != NULL; i ++){
    //DEBUGPRINT2("main:set command line option (string)    Loop [%s] [%s]\n",
    //       commandline,commandlinelist[i].value )
   p = strstr_ex(commandline,commandlinelist1[i].option);
   if(p){


		add_command_list_brcommand(commandlinelist1[i].value);
    }
  }
...
#if 0	/*SERIES1. Developer2. 20080715*/
  //************************************
...
int exec_brprintconf(char *brprintconf,char *printer){
  ...
  {
    if ( 0 == strcmp( MFC_J6510DW, printer ) && 0 == strcmp( command_array[i].option, "-feed" ) )
    {
	continue ;
    }

    if (  (0 == strcmp( MFC_J6310W, printer ) && 0 == strcmp( command_array[i].option, "-feed" ) )
     	||(0 == strcmp( MFC_J6310W, printer ) && 0 == strcmp( command_array[i].option, "-duplex" ) )
      	||(0 == strcmp( MFC_J6310W, printer ) && 0 == strcmp( command_array[i].option, "-duplexmode" ) )
        ||(0 == strcmp( MFC_J6310W, printer ) && 0 == strcmp( command_array[i].option, "-pt" ) && 0 == strcmp( command_array[i].value, "Tabloid_Duplex" ) )
        ||(0 == strcmp( MFC_J6310W, printer ) && 0 == strcmp( command_array[i].option, "-pt" ) && 0 == strcmp( command_array[i].value, "BrA3_S_Duplex" ) ) 
        ||(0 == strcmp( MFC_J6310W, printer ) && 0 == strcmp( command_array[i].option, "-pt" ) && 0 == strcmp( command_array[i].value, "BrA3_Duplex" ) ) 
        ||(0 == strcmp( MFC_J6310W, printer ) && 0 == strcmp( command_array[i].option, "-pt" ) && 0 == strcmp( command_array[i].value, "B4_Duplex" ) ) 
        ||(0 == strcmp( MFC_J6310W, printer ) && 0 == strcmp( command_array[i].option, "-pt" ) && 0 == strcmp( command_array[i].value, "BrB4_S_Duplex" ) ) 
        ||(0 == strcmp( MFC_J6310W, printer ) && 0 == strcmp( command_array[i].option, "-pt" ) && 0 == strcmp( command_array[i].value, "BrLedger_S_Duplex" ) )
        ||(0 == strcmp( MFC_J6310W, printer ) && 0 == strcmp( command_array[i].option, "-md" ) && 0 == strcmp( command_array[i].value, "PlainDuplex" ) ) 
        )
     {
	continue ;
     }
...
int add_command_list_brcommand_sub(char  *command){
  ...
  option[strlen(option)] = 0;	/*SERIES1. Developer2. 20080715*/
